                                            ...
                                            ";
                                                ...
                                                <?php
                                                 ...
                                                 if($rs['status'] == 'Active')
                                                 {
                                                   echo "
                                                   <td>
                                                   <a href='disable_section.php?id=$rs[id]' class='btn btn-outline-warning btn-sm'>  </i> Disable</a> &nbsp;&nbsp;
                                                   <a href='del_section.php?id=$rs[id]' class='btn btn-danger btn-sm'>  <i class='fa fa-close'></i> Delete</a> </td>
                                                 ...
                                                 else
                                                 {
                                                   echo "
                                                   <td>
                                                   <a href='active_section.php?id=$rs[id]' class='btn btn-outline-success btn-sm'>  </i> Active</a> &nbsp;&nbsp;
                                                   <a href='del_section.php?id=$rs[id]' class='btn btn-danger btn-sm'>  <i class='fa fa-close'></i> Delete</a> </td>
