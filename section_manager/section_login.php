            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="section_register.php">Sign Up</a></li>
...
<form action="section_loginprocess.php" method='POST' enctype="multipart/form-data" >
  <div class="main">
    <p class="header1">Asset Tracking </p>
  <h4 class="header2">Section Manager LOGIN</h4>
