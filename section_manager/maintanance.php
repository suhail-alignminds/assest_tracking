...
<?php include('section_header.php'); ?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Maintanance Request</h1>
                                          ...
                                          
                                     {
                                          ...
                                          else
                                          {
                                            ...
                                            ";
                                               ...
                                               echo  "
                                            <td> <a href='request_maint.php?asset_id=$rs[asset_id]' class='btn btn-outline-danger btn-sm'>  </i> Request Maintanance</a> &nbsp;&nbsp; </td>
